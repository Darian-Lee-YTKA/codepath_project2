...
class SettingsViewController: UIViewController {
  ...
  private var turkishThemeAction: UIAction!
  ...
  override func viewDidLoad() {
    ...
    animalThemeAction = UIAction(title: "Animals",
      ...
      turkishThemeAction = UIAction(title: "Turkish",
                                   state: theme == .turkish ? .on : .off,
                                   handler: { [unowned self] action in
        self.didTapTurkishThemeButton()
      })
    wordThemeButton.menu = UIMenu(children: [normalThemeAction, countryThemeAction, animalThemeAction, turkishThemeAction])
  ...
  private func didTapAnimalsThemeButton() {
    ...
    private func didTapTurkishThemeButton() {
      turnOnTheme(theme: .turkish)
    }
